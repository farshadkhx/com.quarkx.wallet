...
QuarkX Wallet is now a truly universal multi-wallet and at the same time likely the most comprehensive non-custodial Bitcoin wallet around. Not only are users now able to create/restore standard-compliant Bitcoin wallets but also export existing wallets to QuarkX using any of the following:
...
Wallet users on Ethereum and other EVM chains can now export existing wallets to QuarkX using EVM Private Key. Previously EVM wallet export was limited to mnemonic phrases.
