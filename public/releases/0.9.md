...
All new wallets are now going to be BIP49 wallets while the QuarkX wallets created before that will continue to operate in BIP44 manner. That should enable anyone to export any external  BIP49 wallet into QuarkX app and vice versa.

### Price Alert Notifications

We have added means to set price changes alerts in QuarkX settings. It is now possible to set notification alerts for cases when crypto prices change more than 2%, 3% or 5%.
