...
The QuarkX now fully supports WalletConnect v2. Both version 1 and 2 of the WalletConnect protocol are now supported by the app enabling users to interact with all DApps using WalletConnect.
...
The QuarkX now supports non-custodial storage, sending and receiving of SOL cryptocurrency as well as tokens on Solana blockchain.
