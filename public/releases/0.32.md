...
QuarkX Wallet now supports Bitcoin's Taproot upgrade and allows the creation of Taproot-enabled Bitcoin wallets (BIP86).
...
The library powering Zcash (ZEC) cryptocurrency has been upgraded. This is the major upgrade from the folks building the Zcash protocol and QuarkX is one of the very first wallets implementing it.
