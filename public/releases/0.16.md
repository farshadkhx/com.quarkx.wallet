...
The biggest feature of the current sprint. This release brings full integration of Uniswap protocol to QuarkX wallet app.

You can now buy and sell Ethereum and Ethereum based ERC20 tokens directly from within QuarkX in a decentralized manner, without any identity checks or privacy leaks.
...
Apart from 24h price changes QuarkX can alert you when a short or long term price trend for the given cryptocurrency changes from downtrend to uptrend or vice versa.
...
As we are entering a new phase in DEFI, we try to make sure that QuarkX wallet supports all of the 'blue-chip' projects in the ecosystem. Following tokens were added to the tokens list supported by QuarkX wallet app:
