...
GM free souls! Here comes another major upgrade to the QuarkX Wallet app.

## BINANCE WALLET

QuarkX wallet users can now import their Binance exchange wallets to QuarkX in read-only mode for easy monitoring of exchange balances.
...
The tech support functionality in the wallet now works through Telegram enabling users to chat directly with the QuarkX team securely and privately. Smoother and faster.
