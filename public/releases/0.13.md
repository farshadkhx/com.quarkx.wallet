...
The security section in app settings now includes a dedicated privacy control screen. Privacy settings on that screen provide you with everything you need to manage your level of privacy when using QuarkX as well as things you should know in general.
...
Due to the lack of feedback on App Store and Play Market we are having problem getting QuarkX listed on Bitcoin.org. if you're reading this do humanity a favor and rate/review our app on App Store / Play Market.
