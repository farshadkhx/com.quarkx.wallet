...
QuarkX constantly working on improving decentralized token swapping capabilities to enable token swapping at optimal rates. This version features:
...
The latest update brings a new version of the FAQ page. This page was redone addressing the most common questions and usage issues that users have experienced with QuarkX over the past.

https://quarkx.money/faq
...
Zcash users now have the ability to send transactions to transparent addresses. Previously, QuarkX supported only shielded addresses.
