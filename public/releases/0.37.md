...
GM Free Souls! We're thrilled to introduce QuarkX Wallet version 0.37, a substantial release!
...
We are excited to announce that starting this version of QuarkX supports the TON (The Open Network) blockchain. Users are now able to send/receive/store TON assets.
...
QuarkX Wallet aims to improve its cryptocurrency wallet by prioritizing efficiency and security. User feedback and suggestions are highly valued to enhance the app.
