...
It was starting from version 0.30 QuarkX uses BIP84 format as default for all Bitcoin wallets. While this format has been supported for a long time now it wasn't a default option when creating new Bitcoin wallets.
