...
export const metadata = {
  ...
  description:
    'The terms governing your use of QuarkX Wallet — a non-custodial crypto wallet built for real self-custody and financial freedom.',
  alternates: {
    canonical: '/tos',
  },
  openGraph: {
    title: 'Terms of Service — QuarkX Wallet',
    description:
      'The terms governing your use of QuarkX Wallet — a non-custodial crypto wallet built for real self-custody and financial freedom.',
    url: 'https://quarkx.money/tos',
  },
}
  ...
  return (
    <Page black>
      <div className="container text-white">
        <h1>Terms of Service – QuarkX Wallet</h1>
        <p className="text-grey">Last Updated: May 28, 2025</p>

        <div>
          <h2 className="pt-3">1. Intro</h2>
          Hey there. You’re using QuarkX Wallet — a non-custodial crypto wallet built for real self-custody and
          financial freedom.
          ...
          <p>By using QuarkX, you’re saying:</p>
          <ul>
          ...
          <p>
            QuarkX is non-custodial — meaning we never hold your coins, private keys, or seed phrases.
          ...
          <p>
            QuarkX isn’t here to help anyone break laws. Don’t use it for:
          </p>
          <ul>
