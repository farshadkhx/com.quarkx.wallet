...
export const metadata = {
  ...
  description:
    'How QuarkX Wallet handles information. We are non-custodial and collect no personal data — all sensitive data stays on your device.',
  alternates: {
    canonical: '/privacy-policy',
  },
  openGraph: {
    title: 'Privacy Policy — QuarkX Wallet',
    description:
      'How QuarkX Wallet handles information. We are non-custodial and collect no personal data — all sensitive data stays on your device.',
    url: 'https://quarkx.money/privacy-policy',
  },
}
  ...
  return (
    <Page black>
      <div className="container text-white">
        <h1>Privacy Policy – QuarkX Wallet</h1>
        <p className="text-grey">Last Updated: May 28, 2025</p>

        <div>
          <h2 className="pt-4">1. Introduction</h2>
          <p>
            Your privacy is important to us. This Privacy Policy outlines how QuarkX Wallet (“we”, “us”, “our”) handles information in connection
