...
export const metadata = {
  ...
  description:
    'Answers to common questions about QuarkX Wallet — self-custody, security, supported blockchains, transactions, fees and privacy.',
  alternates: {
    canonical: '/faq',
  },
  openGraph: {
    title: 'FAQ — QuarkX Wallet',
    description:
      'Answers to common questions about QuarkX Wallet — self-custody, security, supported blockchains, transactions, fees and privacy.',
    url: 'https://quarkx.money/faq',
  },
}
