# Which DEXes supported in QuarkX?

QuarkX wallet currently supports following decentralized exchanges:
...
In the near future, QuarkX aims to complete integration with Thorchain (https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains for the first time.
