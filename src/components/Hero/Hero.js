      ...
      <div className="container d-flex flex-column">
        <div className="row g-5 align-items-center" style={{ flexGrow: 3 }}>
          ...
          <div className="col-lg-6 d-flex justify-content-center">
            <img className="hero-image" src="/images/banner/wallet-2.png" alt="QuarkX Wallet app shown on a smartphone" />
          </div>
        </div>
          ...
          <div className="col-md-6 col-sm-12">
            ...
            <ul className="nav nav-pills nav-justified">
              <li className="nav-item mb-2">
                <a href="https://bitcoin.org/en/wallets/mobile/ios/quarkx/" target="_blank" rel="noopener noreferrer">
                  <Image src="/images/banner/bitcoin.svg" alt="Listed on Bitcoin.org" width="100" height="27" />
                </a>
              </li>
              <li className="nav-item mb-2">
                <a href="https://www.certik.com/resources/blog/quarkxmobilewalletapppassesthroughformalvaptwithcertik" target="_blank" rel="noopener noreferrer">
              ...
              <li className="nav-item mb-2">
                <a href="https://immunefi.com/bug-bounty/quarkxwallet/information/" target="_blank" rel="noopener noreferrer">
