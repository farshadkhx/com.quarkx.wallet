    ...
    <main>
      ...
      <Page black>
        <div className="container">
          <PageHeader
            ...
            description="Self-Custody is great, but existing tools are complex. QuarkX fixes that."
            column
          />
        ...
        <div className="container">
          ...
          <div className="row py-5 g-3">
            <div className="col-sm-12 col-md-6 col-lg-3">
              <Card
                title="Open-Source"
                description="QuarkX is a verifiably open source wallet which is recommended by highly respected sources."
          ...
          <div className="row py-5 g-3">
            <div className="col-md-6 col-lg-4">
              <CardPartner
                ...
                text="QuarkX is the first multi-coin wallet that supports Bitcoin, Ethereum, and fully shielded Zcash, as well as other coins, and it has a strong, user-centric architecture in which the users own their own keys and their own privacy."
                link="https://z.cash/ecosystem/quarkx"
              />
            </div>
            <div className="col-md-6 col-lg-4">
              <CardPartner
            ...
            <div className="col-md-6 col-lg-4">
              <CardPartner
                ...
                text="It’s rare to find a product that combines ease of use with top-notch security like QuarkX Wallet. This is a wallet I would recommend to anyone who values privacy and reliability."
            ...
            <div className="col-md-6 col-lg-4">
              <CardPartner
                ...
                text="The support of QuarkX Money for privacy is now going to the next level, first with support of Shielded ZCash and now with the support of Nym, whose mixnet can protect the IP address and metadata of its users."
            ...
            <div className="col-md-6 col-lg-4">
              <CardPartner
                ...
                text="We highly recommend QuarkX Wallet to our users and partners, and our team uses it internally. At dRPC, we value privacy and reliability, and appreciate QuarkX's commitment to open-source efforts."
            ...
            <div className="col-md-6 col-lg-4">
              <CardPartner
                ...
                text="QuarkX Wallet is listed on Bitcoin.org, one of the most trusted and community- driven resources for Bitcoin education and wallet recommendations. Our presence on Bitcoin.org underscores our commitment to non-custodial security, privacy, and transparency."
                link="https://bitcoin.org/en/wallets/mobile/ios/quarkx/"
              />
            </div>
            <div className="col-md-6 col-lg-4">
              <CardPartner
                logo="/images/partners/hashdit.png"
                text="QuarkX Wallet has demonstrated a strong commitment to user security by integrating HashDit's threat wallet address API. This integration prevents their customers from sending funds to scammers or malicious actors. We appreciate their dedication to user safety and value our collaboration."
            ...
            <div className="col-md-6 col-lg-4">
              <CardPartner
                ...
                text="QuarkX Wallet is featured on Ethereum.org, the official website of the Ethereum ecosystem, as a secure and open-source wallet for managing Ethereum and ERC-20 tokens. This listing reflects our dedication to decentralized finance and self-custody."
            ...
            <div className="col-md-6 col-lg-4">
              <CardPartner
                ...
                text="QuarkX Wallet has passed WalletScrutiny's verification process, demonstrating that our app is open-source and verifiable. WalletScrutiny evaluates wallets to ensure they match their published source code, reinforcing trust and security in the crypto community."
            ...
            <div className="col-md-6 col-lg-4">
              <CardPartner
                ...
                text="QuarkX Wallet is available on F-Droid, a well-known repository for open-source Android apps. Being listed on F-Droid highlights our commitment to privacy, transparency, and open-source principles, allowing users to install our app from a trusted, independent source."
            ...
            <div className="col-md-6 col-lg-4">
              <CardPartner
                ...
                text="Security is a top priority for QuarkX Wallet, which is why we are featured on Immunefi, a leading bug bounty platform for Web3 projects. Our listing on Immunefi helps us engage with security researchers to proactively identify and resolve vulnerabilities, ensuring a safer experience for our users."
                link="https://immunefi.com/bug-bounty/quarkxwallet/information/"
              />
            </div>
          </div>
        </div>
      ...
      <Page black>
        <div className="container">
          <PageHeader
            title="Proof of Work"
            description="Take a look at the milestones we’ve completed and the progress that defines QuarkX Wallet."
            column
          />
