# What should someone do before using QuarkX?

Before doing anything on QuarkX you're strongly encouraged to go over the Academy section and get familiar with essential aspects of cryptocurrency and DeFi ecosystem.
...
Apart from Academy, users are recommended to go over QuarkX terms (Settings > About section) and make sure they understand what QuarkX wallet is and risks involved in using the app.
