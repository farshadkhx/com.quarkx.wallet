...
To be able to display the overall transferred amount in USD, EUR etc for past crypto transactions QuarkX needs to know the valid exchange rate at the date of transaction. QuarkX relies on Coingecko.com for that data.
