# Does QuarkX charge fees for sending transactions?
...
These transaction fees do not pass through QuarkX but paid by the user directly to the network when executing transactions.
