...
- A non-custodial mobile wallet app like QuarkX may potentially be more private than a hardware wallet. The purchase, delivery, and proper setup of a hardware wallet device carry some privacy and security risks. A recent incident on Ledger (leading hardware wallet brand) ended up exposing customer names, phone numbers and physical addresses of customers who purchased Ledger hardware wallet.
