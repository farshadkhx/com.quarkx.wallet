...
- After both options are selected, QuarkX displays the real time swap rate for selected coins and trade details.

By default, QuarkX attempts to route the order through 1inch for optimum trade prices.
