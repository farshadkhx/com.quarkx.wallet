# Which DEXes are supported in QuarkX?

QuarkX wallet currently supports the following decentralized exchanges:
...
In the future, QuarkX aims to complete integration with the [Thorchain](https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains.
