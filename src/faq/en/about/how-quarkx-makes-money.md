# How does QuarkX make money?

QuarkX is a free to use instrument that keeps all of its fundamental features free.
...
The features above are already in the implementation stage, and are designed to enable the QuarkX team to monetize itself and financially operate in DAO format moving forward.

Premium wallet features are expected to be available only to those holding special QuarkX wallet tokens.
