# What to do before using QuarkX

Before doing anything on QuarkX, users are encouraged to go over the Academy section and get familiar with essential aspects of cryptocurrency and the DeFi ecosystem.
...
Users are also advised to go over the App Terms (**Settings > About**) and make sure they understand what QuarkX wallet is and the risks involved while using the app.
